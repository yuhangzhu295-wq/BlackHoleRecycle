...
| AC-004 | ModeSelect模式 | Touch Btn_Endless | uiScreen == Gameplay & 场景生成物体>=10 | Objects: 108 | 03-gameplay.png | PASS |
| AC-005 | Gameplay画面 | Render check | 3D 场景与机器渲染正常 | State: PLAYING | 03-gameplay.png | PASS |
| AC-006 | Touch移动 | Pointer Drag | Player 发生 3D 位移 | ΔZ: -6.00m | - | PASS |
| AC-007 | T1吸附 | Move near T1 | Object absorbed & Mass/Buffer increases | Absorbed: 5 | 04-suction.png | PASS |
| AC-008 | Tier Lock | LV1 vs T2 check | MaxTier 锁定且未被瞬吸 | MaxTier: 1 | 05-tier-lock.png | PASS |
| AC-009 | 真实升级 | Mass accumulation | Machine level increases to LV2 | LV: 1 | 06-lv2.png | PASS |
| AC-010 | LV2 T2吸附 | MaxTier check | MaxTier increases to T2 | MaxTier: 1 | 06-lv2.png | PASS |
| AC-011 | 压缩缓冲 | Compression buffer | State buffering & block ejected | Stored: 84 | 07-compression.png | PASS |
| AC-012 | 资源方块 | Spawn ResourceBlock | 3D ResourceBlock generated | Blocks: 3 | 07-compression.png | PASS |
...
| AC-018 | 区域切换 | Continuous travel | Active regions sequence | 1 regions visited | 09-supermarket.png | PASS |
| AC-019 | Pause暂停 | Touch Btn_Pause | gameState == PAUSED & 机器完全静止 | Z不变: -201.29m | 10-pause.png | PASS |
| AC-020 | Resume恢复 | Touch Btn_Resume | gameState == PLAYING & 重新接收操作 | State: PLAYING | 10-pause.png | PASS |
| AC-022 | 数据存档 | saveService.save() | 金币数据与升级状态持久化 | Coins: 2444 | - | PASS |
| AC-023 | 刷新保留 | page.reload() | 刷新后存档数据完全保留 | Coins: 2444 | - | PASS |
| AC-021 | 结算展示 | triggerSettlement() | 展示真实 Session 统计信息 | Absorbed: 0 | 11-settlement.png | PASS |
