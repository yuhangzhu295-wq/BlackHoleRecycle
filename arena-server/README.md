...
This is an actual local Colyseus 0.18 authority slice: multiple clients join `black_hole_arena`, send sequenced normalized movement input, and receive server-owned positions, recyclable suction state, mass, LV1-to-LV2 progression, T2 eligibility, player defeat, dropped mass fragments, respawn, protection, a server-generated match id, match finish reason, and a per-player reward ledger.
